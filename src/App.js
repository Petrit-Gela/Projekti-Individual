...
export default function App() {
       ...
       <div className="row min-vh-100">
         <div className="col d-flex flex-column justify-content-center align-items-center">
          {(showingCreateNewPostForm === false && postCurrentlyBeingUpdated === null) && (
            <div>
            <h1 style={ {textAlign:"center"} }>Post Website</h1>
              <div className="mt-5">
  ...
  function onPostUpdated(updatedPost) {
    ...
    alert(`Post successfuly updated. After clicking OK, look for the post with the title "${updatedPost.title}" in the table below to see the updates.`);
  }
  ...
  function onPostDeleted(deletedPostPostId) {
    ...
    alert('Post succesfully deleted. After clicking OK, look at the table below to see your post disappear.');
  }
}
